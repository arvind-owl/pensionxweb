            ...
            <p  dangerouslySetInnerHTML={{
              ...
              <p  dangerouslySetInnerHTML={{
                __html: banner?.acf?.how_much_content,
							...
							<a href={banner?.acf?.how_much_button_link?banner?.acf?.how_much_button_link:"#"} className="Check-it-out">{banner?.acf?.how_much_button}</a>
						</div>
					</div>
				</div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 col-lg-offset-1 col-lg-6">
            ...
            <a href={banner?.acf?.life_event_button_link ?banner?.acf?.life_event_button_link:"#"} className="desktop-only view-more-btn">{banner?.acf?.life_event_button_text}</a>
          </div>
          <div className="col-md-6 col-lg-5">
          <p  dangerouslySetInnerHTML={{
                __html: banner?.acf?.life_event_extra_content,
              }} />
              <a href={banner?.acf?.life_event_button_link ?banner?.acf?.life_event_button_link:"#"} className="mobile-only view-more-btn">{banner?.acf?.life_event_button_text}</a>
